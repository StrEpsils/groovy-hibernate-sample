...
ALTER TABLE USER ADD CONSTRAINT USER_ID_UNQ UNIQUE (USER_ID);
ALTER TABLE USER ADD CONSTRAINT USER_NAME_UNQ UNIQUE (NAME);

ALTER TABLE ROLE ADD CONSTRAINT ROLE_ID_UNQ UNIQUE (ROLE_ID);
ALTER TABLE ROLE ADD CONSTRAINT ROLE_NAME_UNQ UNIQUE (NAME);

ALTER TABLE USER_ROLE ADD CONSTRAINT USER_ROLE_ID_UNQ UNIQUE (USER_ROLE_ID);
ALTER TABLE USER_ROLE ADD CONSTRAINT USER_USER_ID_ROLE_ID_UNQ UNIQUE (USER_ID, ROLE_ID);
