...
class DocumentRestApi {
    ...
    ResponseEntity create(@RequestBody String json){
        documentHandler.createDocument json
    }

    @RequestMapping(value = "/", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity update(@RequestBody String json){
        documentHandler.updateDocument json
    }
    ...
    ResponseEntity findDocument(
        ...
        documentHandler.findDocument(documentName, documentId)
    }
    ...
    ResponseEntity findDocumentsByIdDocumentType(
        ...
        documentHandler.findDocumentsByDocumentType(documentTypeCode, documentTypeName)
    }
